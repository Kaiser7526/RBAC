...
const SignUp = ({ show, closeSignUpModal }) => {
  ...
  const handleSignUp = () => {
    ...
    if (!name) {
      ...
      setNameError("Name can only contain letters, spaces, or hyphens.");
      isValid = false;
    } else {
      setNameError("");
    }
    ...
    <ModalOverlay show={show}>
      <ModalContainer isDarkMode={isDarkMode}>
        ...
        <Input
          ...
          value={name}
          onChange={(e) => handleInputChange(setName, e.target.value, setNameError)}
        ...
        <Input
          ...
          onChange={(e) => handleInputChange(setConfirmPassword, e.target.value, setConfirmPasswordError)}
          isDarkMode={isDarkMode}
